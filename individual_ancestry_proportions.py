...
def get_admixture_proportions(ts, admix_inds, popA_nodes, popB_nodes, popC_nodes, popD_nodes, max_time):
	...
	ancestry_arr = np.stack((admix_inds, proportions_A, proportions_B, proportions_C, proportions_D, proportions_Total), axis=-1)
	ancestry_df = pd.DataFrame(ancestry_arr, columns=["Indivicual", "P1AncestryProportion", "P2AncestryProportion", "P3AncestryProportion", "P4AncestryProportion", "Total"])
